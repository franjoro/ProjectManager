    ...
    m = (t, e) => {
      (l = !0),
        $("#order_data2").DataTable({
          ...
          columnDefs: [
            { title: "Description", targets: 0 },
            { title: "Provider", targets: 1 },
            { title: "Bill", targets: 2 },
            { title: "Total Paid", targets: 3 },
            { title: "Date", targets: 4 },
            { title: "Project Name", targets: 5 },
          ],
          columns: [
            { data: "descri", name: "WorkZone" },
            { data: "name", name: "code" },
            { data: "bill", name: "code" },
            { data: "total", name: "code" },
            { data: "date", name: "code" },
