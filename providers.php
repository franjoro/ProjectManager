            ...
            <div class="col-lg-5 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Agregar nuevo proveedor /
                    codigo de proveedor: <span style="color: black;">ABC</span>
                  </h6>
                ...
                <div class="card-body">
                  <form id="providersForm">
                    <div class="form-group">
                      ...
                      <input type="text" required class="form-control" id="name" name="name" placeholder="Provider Name...">
                    </div>

                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Acct No.</label>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">MGR.</label>
