            ...
            <div class="col-lg-5 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Agregar nuevo cliente /
                    codigo de cliente: <span style="color: black;">ABC</span>
                  </h6>
                ...
                <div class="card-body">
                  ...
                  <form id="clienteForm">
                    <div class="form-group">
                      ...
                      <input type="text" required class="form-control" name="name" placeholder="John Do...">
                    </div>
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" autocomplete class="form-control" name="contact">
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="inputAddress2">Address</label>
                      <textarea class="form-control" name="address" placeholder="Apartment, studio, or floor"></textarea>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-4">
                        <label for="inputCity">Phone Office</label>
                        <input type="text" class="form-control" name="phoneOf">
                      </div>
                      <div class="form-group col-md-4">
                        <label for="inputState">Phone Cel</label>
                        <input type="text" class="form-control" name="phoneCel">

                      </div>
                      <div class="form-group col-md-4">
                        <label for="inputZip">Phone Other</label>
                        <input type="text" class="form-control" name="PhoneOth">
                      </div>
                    </div>
                    <div class="form-group">
