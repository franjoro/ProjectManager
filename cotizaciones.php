    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Cotizaciones para clientes</h1>
          <form id="CotizacionesForm">
            <div class="form-row">
              <div class="form-group col-md-2">
                <label for="inputEmail4">Seleccionar Proyecto</label>
                <select class="form-control" name="ProjectSelectorCtciones" id="ProjectSelectorCtciones">
        ...
        <div class="card shadow mb-4 materialesDiv">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Agregar materiales para cotizaciones de clientes</h6>
          </div>
          <div class="card-body">
            <form id="rowsC">
