<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    $sql = "SELECT tb_proyectos.code, tb_proyectos.name, tb_clientes.name, tb_propiedades.name, tb_proyectos.datestart, tb_proyectos.dateend, tb_proyectos.notes, tb_clientes.code, tb_proyectos.invoiceCode  FROM tb_proyectos INNER JOIN tb_clientes ON tb_proyectos.cliente = tb_clientes.code INNER JOIN tb_propiedades ON tb_proyectos.propiedad = tb_propiedades.code WHERE tb_proyectos.status='0' ";
